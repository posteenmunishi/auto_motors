  ...
  return (
    <div className="bg-gray-900 text-white">
      <div className="grid md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-1 py-8">
        <div>
          <h2 className="text-orange-500 font-bold pb-4">Automotors</h2>
          <p className="w-3/4">
        ...
        <div>
          <h2 className="text-orange-500 font-bold pb-4">Links</h2>
          <ul>
        ...
        <div>
          <h2 className="text-orange-500 font-bold pb-4">Follw us on</h2>
          <ul className="flex">
      ...
      <div className="py-5 bg-gray-800">
        <p className="text-center text-orange-300">&copy;copyright 2022, All rights reserved by Automotors</p>
      </div>
    </div>
  )
}
